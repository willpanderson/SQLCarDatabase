...
INSERT INTO `customer` VALUES (201,'A. Parks','(214) 555-0127'),(202,'S. Patel','(849) 811-6298'),(203,'A. Hernandez','(355) 572-5385'),(204,'G. Carver','(753) 763-8656'),(205,'Sh. Byers','(912) 925-5332'),(206,'L. Lutz','(931) 966-1775'),(207,'L. Bernal','(884) 727-0591'),(208,'I. Whyte','(811) 979-7345'),(209,'L. Lott','(954) 706-2219'),(210,'G. Clarkson','(309) 625-1838'),(211,'Sh. Dunlap','(604) 581-6642'),(212,'H. Gallegos','(961) 265-8638'),(213,'L. Perkins','(317) 996-3104'),(214,'M. Beach','(481) 422-0282'),(215,'C. Pearce','(599) 881-5189'),(216,'A. Hess','(516) 570-6411'),(217,'M. Lee','(369) 898-6162'),(218,'R. Booker','(730) 784-6303'),(219,'A. Crowther','(325) 783-4081'),(220,'H. Mahoney','(212) 262-8829'),(221,'J. Brown','(644) 756-0110'),(222,'H. Stokes','(931) 969-7317'),(223,'J. Reeves','(940) 981-5113'),(224,'A. Mcghee','(838) 610-5802'),(225,'L. Mullen','(798) 331-7777'),(226,'R. Armstrong','(325) 783-4081'),(227,'J. Greenaway','(212) 262-8829'),(229,'D. Kirkpatrick','(773) 696-8009'),(230,'A. Odonnell','(439) 536-8929'),(231,'K. Kay','(368) 336-5403');
...
INSERT INTO `rental` VALUES (203,'JM3KE4DY4F0441471','2019-09-09','2019-05-22',1,4,'2019-09-13',460,'2019-09-09',NULL),(210,'19VDE1F3XEE414842','2019-11-01','2019-10-28',7,2,'2019-11-15',1200,NULL,NULL),(210,'JTHFF2C26F135BX45','2019-05-01','2019-04-15',7,1,'2019-05-08',600,'2019-05-08',NULL),(210,'JTHFF2C26F135BX45','2019-11-01','2019-10-28',7,2,'2019-11-15',1200,NULL,NULL),(210,'WAUTFAFH0E0010613','2019-11-01','2019-10-28',7,2,'2019-11-15',1200,NULL,NULL),(210,'WBA3A9G51ENN73366','2019-11-01','2019-10-28',7,2,'2019-11-15',1200,NULL,NULL),(210,'WBA3B9C59EP458859','2019-11-01','2019-10-28',7,2,'2019-11-15',1200,NULL,NULL),(210,'WDCGG0EB0EG188709','2019-11-01','2019-10-28',7,2,'2019-11-15',1200,NULL,NULL),(212,'19VDE1F3XEE414842','2019-06-10','2019-04-15',7,3,'2019-07-01',1800,'2019-06-10',NULL),(216,'1N6BF0KM0EN101134','2019-08-02','2019-03-15',7,4,'2019-08-30',2740,'2019-08-02',NULL),(216,'1N6BF0KM0EN101134','2019-08-30','2019-03-15',1,2,'2019-09-01',230,'2019-08-02',NULL),(221,'19VDE1F3XEE414842','2019-07-01','2019-06-12',7,1,'2019-07-08',600,'2019-07-01',NULL),(221,'19VDE1F3XEE414842','2019-07-09','2019-06-12',1,2,'2019-07-11',200,'2019-07-01',NULL),(221,'19VDE1F3XEE414842','2020-01-01','2019-12-15',7,4,'2020-01-29',2400,NULL,NULL),(221,'JTHFF2C26F135BX45','2020-01-01','2019-12-15',7,4,'2020-01-29',2400,NULL,NULL),(221,'WAUTFAFH0E0010613','2019-07-01','2019-06-12',7,1,'2019-07-08',600,'2019-07-01',NULL),(221,'WAUTFAFH0E0010613','2019-07-09','2019-06-12',1,2,'2019-07-11',200,'2019-07-01',NULL),(221,'WAUTFAFH0E0010613','2020-01-01','2019-12-15',7,4,'2020-01-29',2400,NULL,NULL),(221,'WBA3A9G51ENN73366','2020-01-01','2019-12-15',7,4,'2020-01-29',2400,NULL,NULL),(221,'WBA3B9C59EP458859','2020-01-01','2019-12-15',7,4,'2020-01-29',2400,NULL,NULL),(221,'WDCGG0EB0EG188709','2020-01-01','2019-12-15',7,4,'2020-01-29',2400,NULL,NULL),(229,'19VDE1F3XEE414842','2019-05-06','2019-04-12',1,4,'2019-05-10',400,'2019-05-06',NULL),(229,'WAUTFAFH0E0010613','2019-05-06','2019-04-12',1,4,'2019-05-10',400,'2019-05-06',NULL);
...
/*!50001 VIEW `vrentalinfo` AS select `rent`.`OrderDate` AS `OrderDate`,`rent`.`StartDate` AS `StartDate`,`rent`.`ReturnDate` AS `ReturnDate`,(dayofmonth(`rent`.`ReturnDate`) - dayofmonth(`rent`.`StartDate`)) AS `TotalDays`,`v`.`VehicleID` AS `VIN`,`v`.`Description` AS `Vehicle`,(case when (`v`.`Type` = 1) then 'Compact' when (`v`.`Type` = 2) then 'Medium' when (`v`.`Type` = 3) then 'Large' when (`v`.`Type` = 4) then 'SUV' when (`v`.`Type` = 5) then 'Truck' when (`v`.`Type` = 6) then 'Van' end) AS `Vehicle Type`,(case when (`v`.`Category` = 0) then 'Basic' when (`v`.`Category` = 1) then 'Luxury' end) AS `Category`,`customer`.`CustID` AS `CustomerID`,`customer`.`Name` AS `CustomerName`,`rent`.`TotalAmount` AS `OrderAmount`,(case when (`rent`.`PaymentDate` <> 'NULL') then `rent`.`TotalAmount` else 0 end) AS `RentalBalance` from (((`vehicle` `v` join `rental` `rent` on((`rent`.`VehicleID` = `v`.`VehicleID`))) join `customer` on((`customer`.`CustID` = `rent`.`CustID`))) join `rate` on(((`v`.`Type` = `rate`.`Type`) and (`v`.`Category` = `rate`.`Category`)))) */;
...
-- Dump completed on 2021-05-04 20:02:30
-- MySQL dump 10.13  Distrib 8.0.23, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2021-03-31 03:15:13',NULL),('diagnostics.include_raw','OFF','2021-03-31 03:15:13',NULL),('ps_thread_trx_info.max_length','65535','2021-03-31 03:15:13',NULL),('statement_performance_analyzer.limit','100','2021-03-31 03:15:13',NULL),('statement_performance_analyzer.view',NULL,'2021-03-31 03:15:13',NULL),('statement_truncate_len','64','2021-03-31 03:15:13',NULL);
...
-- Dump completed on 2021-05-04 20:02:31
